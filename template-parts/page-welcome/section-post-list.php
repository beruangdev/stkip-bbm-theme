...
<div class="container flex flex-col md:flex-row md:gap-6">
  <div class="md:basis-8/12 flex flex-col gap-4 mb-4 md:mb-0">
    <div class="flex justify-between items-center mb-3">
      ...
      <a href="<?php echo esc_url(get_post_type_archive_link('post')); ?>" class="group flex items-center gap-2 duration-200  hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg px-5 py-2 dark:hover:bg-background-950/30 focus:outline-none dark:focus:ring-background-800 no-underline">
